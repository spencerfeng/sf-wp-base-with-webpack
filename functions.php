<?php
/**
 * WP Base functions and definitions
 *
...
if ( ! function_exists( 'wpbase_setup' ) ) :
	...
	function wpbase_setup() {
		 ...
		 * If you're building a theme based on WP Base, use a find and replace
...
function wpbase_scripts() {
  ...
  if (is_front_page() && !is_home()) {
    wp_enqueue_style('home', get_stylesheet_directory_uri() . '/dist/home.css');
    wp_enqueue_script('home', get_stylesheet_directory_uri() . '/dist/home.js', array(), '1.0.0', true);
  }
  
  if (is_single()) {
    wp_enqueue_style('single', get_stylesheet_directory_uri() . '/dist/single.css');
    wp_enqueue_script('single', get_stylesheet_directory_uri() . '/dist/single.js', array(), '1.0.0', true);
  }
